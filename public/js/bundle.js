    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 12:
          _context.prev = 12;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)('error', (_err$response = _context.t0.response) === null || _err$response === void 0 ? void 0 : _err$response.data.message);
        case 15:
        case "end":
          return _context.stop();
      }
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (response.request.responseURL) {
            ...
            (0, _alerts.showAlert)('error', 'Something went wrong while booking the tour');
          }
          _context.next = 11;
          break;
        case 7:
          ...
          (0, _alerts.showAlert)('error', ((_err$response = _context.t0.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || 'Could not book tour');
        case 11:
        case "end":
          return _context.stop();
      }
...
var accountDataForm = document.querySelector('.form-user-data');
var accountPasswordForm = document.querySelector('.form-user-password');
...
if (accountDataForm) {
  accountDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
    ...
    form.append('photo', document.querySelector('input[name="photo"]').files[0]);
    (0, _updateSettings.updateSettings)(form, 'data');
  });
}
if (accountPasswordForm) {
  accountPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
